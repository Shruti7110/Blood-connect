...
import type { 
  User, InsertUser, Patient, InsertPatient, Donor, InsertDonor, 
  HealthcareProvider, InsertHealthcareProvider, Transfusion, InsertTransfusion,
  Notification, InsertNotification, EmergencyRequest, InsertEmergencyRequest, DonorFamily
} from '../shared/schema';
