...
class BloodDonationAssistant:
    ...
    async def create_agent_and_mcp(self):
        ...
        try:
            ...
            print(f"Error in create_agent_and_mcp: {traceback.format_exc()}")
        ...
        try:
            ...
            async with mcp_server:
                ...
                try:
                    ...
                    print(f"Error during Runner.run: {traceback.format_exc()}")
            ...
            print(f"Error processing message: {traceback.format_exc()}")  # Log any errors
