export const educationContent = [
  {
    ...
    type: "article",
    description:
      "Learn about thalassemia, its types, inheritance patterns, and how it affects your body.",
    readingTime: "8 min read",
    difficulty: "Beginner",
    tags: ["basics", "genetics", "inheritance"],
    url: "https://www.mayoclinic.org/diseases-conditions/thalassemia/symptoms-causes/syc-20354995",
    ...
    sections: [
      {
        ...
        content:
          "Thalassemia is caused by mutations in genes that control hemoglobin production. These mutations are inherited from parents.",
      },
      {
        subtitle: "Living With Thalassemia",
        content:
          "With proper treatment including regular transfusions and iron chelation therapy, people with thalassemia can live full, productive lives.",
      },
    ],
  },
  {
    ...
    type: "guide",
    description:
      "Everything you need to know about blood transfusions - preparation, process, and aftercare.",
    readingTime: "12 min read",
    difficulty: "Intermediate",
    tags: ["transfusion", "safety", "procedure"],
    url: "https://www.medicalnewstoday.com/articles/327513#what-is-a-blood-transfusion",
    ...
    sections: [
      {
        ...
        content:
          "Blood transfusions are given every 2-4 weeks, take 2-4 hours per session, and require pre-transfusion blood tests.",
      },
      {
        subtitle: "Iron Chelation Therapy",
        content:
          "Iron chelation removes excess iron buildup from regular transfusions using daily oral medications.",
      },
    ],
  },
  {
    ...
    type: "guide",
    description:
      "Tips for healthy living, nutrition, exercise, and mental health support for thalassemia patients.",
    readingTime: "10 min read",
    difficulty: "Beginner",
    tags: ["lifestyle", "nutrition", "exercise", "mental-health"],
    url: "https://www.cdc.gov/thalassemia/living-with/index.html",
    ...
    sections: [
      {
        ...
        content:
          "Limit iron-rich foods, maintain balanced diet with adequate calcium, and avoid alcohol.",
      },
      {
        subtitle: "Exercise Recommendations",
        content:
          "Regular low-impact activities like swimming, walking, and yoga are recommended.",
      },
    ],
  },
  {
    ...
    type: "article",
    description:
      "Guidelines for maintaining treatment schedules, monitoring iron levels, and preventing complications.",
    readingTime: "15 min read",
    difficulty: "Advanced",
    tags: ["complications", "monitoring", "prevention", "iron-levels"],
    url: "https://my.clevelandclinic.org/health/diseases/14508-thalassemias",
    ...
    sections: [
      {
        ...
        content:
          "Never skip scheduled transfusions and maintain regular communication with your healthcare team.",
      },
      {
        subtitle: "Monitoring Guidelines",
        content:
          "Regular monitoring of iron levels and watching for signs of organ complications is essential.",
      },
    ],
  },
];
