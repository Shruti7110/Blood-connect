...
export default function PatientAssistant({ user }: PatientAssistantProps) {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      text: "Hello! I'm your AI health assistant. I can help you with scheduling transfusion appointments, tracking your health metrics, managing your donor family, and answering questions about thalassemia care. How can I assist you today?",
      isBot: true,
      timestamp: new Date(),
    },
  ]);
